...
/**
* _checkelf - it checks if file is elf type
*
* @h: header
*
* Return: No Return
...
/**
* _version - It prints elf version
*
* @h: header
*
* Return: No Return
...
/**
* _abiv - It checks the abi version
*
* @h: header
*
* Return: No Return
...
/**
* _entry - It prints elf entry point access by directly accesing
...
/**
* main - It displays the information contained in the ELF header at
...
{
int Qdelf, relf, closecheck, x64 = 0;
char h[32];
...
Qdelf = open(argv[1], O_RDONLY);
if (Qdelf == -1)
dprintf(STDERR_FILENO, "Can't Open File\n"), exit(98);
relf = read(Qdelf, h, 32);
if (relf == -1)
